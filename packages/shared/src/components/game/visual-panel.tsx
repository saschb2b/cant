...
/**
 * Game panel that renders a live React component for visual/UX challenges.
 *
 * Apps provide a component registry that maps `componentId` strings to actual
 * React components. The app-level wrapper resolves the ID and passes the
 * component here.
 */
