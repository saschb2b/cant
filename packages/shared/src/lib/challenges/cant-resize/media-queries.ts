...
export const mediaQueryChallenges: BaseChallenge[] = [
  {
    id: "mq-001",
...
@media (min-width: 768px) {
  .container {
    ...
    sources: [
      {
        url: "https://developer.mozilla.org/en-US/docs/Learn_web_development/Core/CSS_layout/Media_queries#mobile_first_responsive_design",
...
@media (min-width: 64rem) { /* ~1024px: full layout */ }`,
    ...
    sources: [
      {
        url: "https://www.freecodecamp.org/news/the-100-correct-way-to-do-css-breakpoints-88d6a5ba1862/",
        label: "The correct way to do CSS breakpoints",
      },
    ],
  },
  {
...
@media (min-width: 768px) {
  .sidebar { width: 250px; }
    ...
    sources: [
      {
        url: "https://getbootstrap.com/docs/5.3/layout/breakpoints/#media-queries",
        label: "Bootstrap: Breakpoint media queries",
      },
    ],
  },
  {
...
@media (768px <= width < 1024px) {
  .layout {
    ...
    sources: [
      {
        url: "https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_media_queries/Using_media_queries#syntax_improvements_in_level_4",
        label: "MDN: Media query range syntax",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "MDN: pointer media feature",
      },
    ],
  },
];
