...
export const muiResponsiveChallenges: BaseChallenge[] = [
  {
    id: "mr-001",
    ...
    sources: [
      {
        ...
        label: "MUI: Responsive full-screen dialog",
      },
    ],
  },
  {
...
>`,
  ...
  return (
    ...
    sources: [
      {
        url: "https://mui.com/material-ui/react-drawer/#responsive-drawer",
        label: "MUI: Responsive drawer",
      },
    ],
  },
];
