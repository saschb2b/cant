...
export const overflowHandlingChallenges: BaseChallenge[] = [
  {
    id: "oh-001",
...
.list-item-label {
  ...
  text-overflow: ellipsis;
    ...
    sources: [
      {
        url: "https://css-tricks.com/flexbox-truncated-text/",
        label: "CSS-Tricks: Flexbox truncated text",
      },
    ],
  },
  {
...
.modal-footer { flex-shrink: 0; }`,
    ...
    sources: [
      {
        url: "https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_flexible_box_layout/Controlling_ratios_of_flex_items_along_the_main_axis#setting_a_minimum_size_for_a_flex_item",
        label: "MDN: Flex item minimum size",
      },
    ],
  },
];
