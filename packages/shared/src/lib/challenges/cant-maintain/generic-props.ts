...
export const genericPropsChallenges: BaseChallenge[] = [
  {
    id: "gp-001",
    ...
    sources: [
      {
        ...
        label: "TypeScript: Generic Constraints",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "TypeScript: Type Parameters in Constraints",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "TypeScript: Indexed Access Types",
      },
    ],
  },
];
