...
export const enumeratedVariantsChallenges: BaseChallenge[] = [
  {
    id: "ev-001",
  ...
  severity?: 'error' | 'warning' | 'success' | 'info';
    ...
    sources: [
      {
        url: "https://mui.com/material-ui/api/alert/",
        label: "MUI: Alert API",
      },
    ],
  },
    ...
    sources: [
      {
        ...
        label: "TkDodo: Status Checks in React Query",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "Tailwind: Customizing Spacing",
      },
    ],
  },
  {
  ...
  onClick?: () => void;
    ...
    sources: [
      { url: "https://mui.com/material-ui/api/card/", label: "MUI: Card API" },
    ],
  },
];
