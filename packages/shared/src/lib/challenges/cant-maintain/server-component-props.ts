...
export const serverComponentPropsChallenges: BaseChallenge[] = [
  {
    id: "sc-001",
    ...
    sources: [
      {
        ...
        label: "React Docs: Server Actions",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "React Docs: useActionState",
      },
    ],
  },
  {
...
interface ClientEditorProps {
  ...
  metadata: { title: string; wordCount: number };
    ...
    sources: [
      {
        url: "https://react.dev/reference/rsc/use-client#serializable-types",
        label: "React Docs: Serializable Types",
      },
    ],
  },
  {
