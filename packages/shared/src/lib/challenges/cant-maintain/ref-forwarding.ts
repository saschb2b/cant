...
export const refForwardingChallenges: BaseChallenge[] = [
  {
    id: "rf-001",
  ...
  ref?: React.Ref<HTMLInputElement>;
    ...
    sources: [
      {
        url: "https://react.dev/reference/react/useRef#manipulating-the-dom-with-a-ref",
        label: "React Docs: Manipulating the DOM with a Ref",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "React Docs: useImperativeHandle",
      },
    ],
  },
  {
