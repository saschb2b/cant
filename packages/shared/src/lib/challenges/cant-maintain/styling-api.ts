...
export const stylingApiChallenges: BaseChallenge[] = [
  {
    id: "sa-001",
  ...
  size?: 'sm' | 'md' | 'lg';
    ...
    sources: [
      { url: "https://mui.com/material-ui/api/chip/", label: "MUI: Chip API" },
    ],
  },
  {
    id: "sa-002",
...
function Card({ children, variant, className }: CardProps) {
    ...
    sources: [
      {
        ...
        label: "React Docs: Applying CSS Styles",
      },
    ],
  },
  {
  ...
  classes?: {
    ...
    sources: [
      {
        url: "https://mui.com/material-ui/customization/how-to-customize/#overriding-nested-component-styles",
        label: "MUI: Overriding Nested Styles",
      },
    ],
  },
  {
  ...
  columns: number | {
    ...
    sources: [
      { url: "https://mui.com/material-ui/api/grid/", label: "MUI: Grid API" },
    ],
  },
  {
    id: "sa-008",
