...
export const accessibilityPropsChallenges: BaseChallenge[] = [
  {
    id: "ap-001",
  ...
  isLazy?: boolean;
    ...
    sources: [
      {
        url: "https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img#accessibility",
        label: "MDN: img accessibility",
      },
    ],
  },
  {
  ...
  'aria-describedby'?: string;
    ...
    sources: [
      {
        url: "https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Roles/listbox_role",
        label: "MDN: ARIA Listbox Role",
      },
    ],
  },
];
