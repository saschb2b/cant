...
export const controlledUncontrolledChallenges: BaseChallenge[] = [
  {
    id: "cu-001",
    ...
    sources: [
      {
        ...
        label: "React Docs: Controlling an Input",
      },
    ],
  },
  {
  ...
  onChange: (date: Date) => void;
    ...
    sources: [
      {
        url: "https://react.dev/reference/react-dom/components/input#providing-an-initial-value-for-an-input",
        label: "React Docs: Initial Value for an Input",
      },
    ],
  },
  {
  ...
  placeholder?: string;
    ...
    sources: [
      {
        url: "https://react.dev/reference/react-dom/components/select#controlling-a-select-box-with-a-state-variable",
        label: "React Docs: Controlling a Select Box",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "React Docs: Resetting State with a Key",
      },
    ],
  },
  {
