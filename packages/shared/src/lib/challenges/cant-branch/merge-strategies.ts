...
# Clear that c/d/e were a unit of work`,
    ...
    sources: [
      {
        url: "https://git-scm.com/docs/git-merge#_fast_forward_merge",
        label: "Git Docs: Fast-Forward Merge",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "Git Book: The Perils of Rebasing",
      },
    ],
  },
  {
...
# Feature branch retains full detail`,
    ...
    sources: [
      {
        url: "https://docs.github.com/en/repositories/configuring-branches-and-merges-in-your-repository/configuring-pull-request-merges/about-merge-methods-on-github#squashing-your-merge-commits",
        label: "GitHub Docs: Squash Merge",
      },
    ],
  },
  {
...
# to enforce squash or merge commits`,
    ...
    sources: [
      {
        url: "https://git-scm.com/docs/git-config#Documentation/git-config.txt-branchltnamegtmergeoptions",
        label: "Git Docs: branch.mergeoptions config",
      },
    ],
  },
  {
