...
git revert a1b2c3d`,
    ...
    sources: [
      {
        url: "https://git-scm.com/docs/git-revert#Documentation/git-revert.txt--mparent-number",
        label: "Git Docs: git revert -m",
      },
    ],
  },
  {
