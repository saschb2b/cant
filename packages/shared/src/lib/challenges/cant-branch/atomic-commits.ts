...
z9y8x7w Add avatar upload, fix navbar,
    ...
    sources: [
      {
        url: "https://www.git-scm.com/book/en/v2/Git-Tools-Rewriting-History",
...
and add request logging"`,
    ...
    sources: [
      {
        url: "https://www.git-scm.com/book/en/v2/Git-Tools-Interactive-Staging",
        label: "Git Book: Interactive Staging",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "Martin Fowler: Workflows of Refactoring",
      },
    ],
  },
  {
...
git commit -m "feat: add PaymentMethod type"`,
    ...
    sources: [
      {
        url: "https://www.git-scm.com/docs/git-bisect",
    ...
    sources: [
      {
        ...
        label: "Google Engineering Practices: Small CLs",
      },
    ],
  },
  {
...
git checkout main && git merge feature`,
    ...
    sources: [
      {
        url: "https://www.git-scm.com/docs/git-commit#Documentation/git-commit.txt---fixupamabordsquashltcommitgt",
