...
export const branchingNamingChallenges: BaseChallenge[] = [
  {
    ...
    sources: [
      {
        url: "https://www.git-scm.com/book/en/v2/Git-Branching-Branch-Management",
        label: "Git Book: Branch Management",
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: "https://www.git-scm.com/docs/git-check-ref-format",
        label: "Git Docs: git check-ref-format",
      },
    ],
  },
  {
