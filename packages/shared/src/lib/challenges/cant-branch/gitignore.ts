    ...
    sources: [
      {
        ...
        label: "GitHub Docs: Ignoring files",
      },
    ],
  },
  {
...
# .env.local`,
    ...
    sources: [
      {
        url: "https://github.com/motdotla/dotenv#should-i-commit-my-env-file",
        label: "dotenv: Should I commit my .env file?",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "GitHub Docs: Global gitignore",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "Git Docs: gitignore pattern format",
      },
    ],
  },
  {
      ...
      right: `# .vscode/settings.json (committed)
{
  ...
  "window.zoomLevel": 1
    ...
    sources: [
      {
        url: "https://code.visualstudio.com/docs/getstarted/settings#_workspace-settings",
        label: "VS Code Docs: Workspace settings",
      },
    ],
  },
  {
