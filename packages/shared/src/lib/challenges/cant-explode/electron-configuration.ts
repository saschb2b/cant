...
export const electronConfigurationChallenges: BaseChallenge[] = [
  ...
  },
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/Chromium#Electron_configuration",
        label: "Wikipedia: Chromium electron configuration",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/Iron#Electron_configuration",
        label: "Wikipedia: Iron electron configuration",
      },
    ],
  },
];
