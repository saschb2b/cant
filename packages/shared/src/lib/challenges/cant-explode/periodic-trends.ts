...
export const periodicTrendsChallenges: BaseChallenge[] = [
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/Electronegativity#Variation_of_electronegativity",
        label: "Wikipedia: Electronegativity trends",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "Wikipedia: Ionization energy",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "Wikipedia: Electron affinity",
      },
    ],
  },
];
