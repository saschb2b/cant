...
export const proteinStructureChallenges: BaseChallenge[] = [
  ...
  },
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/DNA#Structure",
        label: "Wikipedia: DNA structure",
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/Protein_structure#Tertiary_structure",
        label: "Wikipedia: Protein tertiary structure",
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/Ribbon_diagram",
        label: "Wikipedia: Ribbon diagram",
      },
    ],
  },
];
