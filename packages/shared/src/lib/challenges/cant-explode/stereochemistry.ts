...
export const stereochemistryChallenges: BaseChallenge[] = [
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/Conformational_isomerism#Ethane",
        label: "Wikipedia: Ethane conformations",
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/Fischer_projection",
        label: "Wikipedia: Fischer projection",
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/Cyclohexane_conformation#Monosubstituted_cyclohexane",
        label: "Wikipedia: Cyclohexane chair conformations",
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/Decalin",
        label: "Wikipedia: Decalin",
      },
    ],
  },
];
