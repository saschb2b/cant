...
export const functionalGroupsChallenges: BaseChallenge[] = [
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/Carboxylic_acid#Reactions",
        label: "Wikipedia: Carboxylic acid reactions",
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/Nucleophilic_addition#Aldehydes_and_ketones",
        label: "Wikipedia: Nucleophilic addition",
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/Amide#Basicity",
        label: "Wikipedia: Amide, Basicity",
      },
    ],
  },
];
