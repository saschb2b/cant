...
export const energyDiagramsChallenges: BaseChallenge[] = [
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/Exothermic_reaction",
        label: "Wikipedia: Exothermic reaction",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/SN1_reaction",
        label: "Wikipedia: SN1 reaction",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "Wikipedia: Activation energy",
      },
    ],
  },
];
