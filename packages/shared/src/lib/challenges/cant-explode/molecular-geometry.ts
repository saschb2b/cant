...
export const molecularGeometryChallenges: BaseChallenge[] = [
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/VSEPR_theory#AX2E2:_Bent",
        label: "Wikipedia: VSEPR bent geometry",
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/VSEPR_theory#AX4:_Tetrahedral",
        label: "Wikipedia: VSEPR tetrahedral geometry",
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/VSEPR_theory#AX3E:_Trigonal_pyramidal",
        label: "Wikipedia: VSEPR trigonal pyramidal",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "Wikipedia: Sulfur hexafluoride",
      },
    ],
  },
];
