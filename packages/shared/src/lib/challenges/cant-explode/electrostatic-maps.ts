...
export const electrostaticMapsChallenges: BaseChallenge[] = [
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/Chemical_polarity",
        label: "Wikipedia: Chemical polarity",
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/Bond_polarity",
        label: "Wikipedia: Bond polarity",
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/Dipole#Molecular_dipoles",
        label: "Wikipedia: Molecular dipoles",
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/Ionic_bonding",
        label: "Wikipedia: Ionic bonding",
      },
    ],
  },
];
