...
export const structuralFormulasChallenges: BaseChallenge[] = [
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/Benzene#Structure",
        label: "Wikipedia: Benzene structure",
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/Ethanol#Physical_properties",
        label: "Wikipedia: Ethanol physical properties",
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/2-Butene",
        label: "Wikipedia: 2-Butene",
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: "https://en.wikipedia.org/wiki/Glucose#Cyclic_forms",
        label: "Wikipedia: Glucose cyclic forms",
      },
    ],
  },
];
