    ...
    sources: [
      {
        ...
        label: "GameDev.net: Spatial Hashing",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "Toptal: Game Physics, Collision Detection",
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: "https://www.gamedev.net/tutorials/programming/math-and-physics/a-verlet-based-approach-for-2d-game-physics-r2714/",
        label: "GameDev.net: Verlet-based 2D Physics",
      },
    ],
  },
];
