...
query GetCustomer($id: ID!) {
  customer(id: $id) {
    ...
    sources: [
      {
        url: "https://graphql.org/learn/best-practices/#server-side-batching-caching",
...
const resolvers = {
  ...
  Query: {
    ...
    sources: [
      {
        url: "https://github.com/graphql/dataloader#batch-function",
        label: "DataLoader: Batch Function",
      },
    ],
  },
  {
...
type Mutation {
  createUser(
    ...
    sources: [
      {
        url: "https://www.apollographql.com/docs/technotes/TN0041-errors-as-data-explained",
        label: "Apollo: Errors as Data",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "Relay: Connection Specification",
      },
    ],
  },
];
