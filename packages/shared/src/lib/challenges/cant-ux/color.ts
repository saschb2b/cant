    ...
    sources: [
      {
        ...
        label: "WCAG 2.1: Understanding contrast minimum",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "Refactoring UI: Choosing a color palette",
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: "https://www.refactoringui.com/",
        label: "Refactoring UI: Text on colored backgrounds",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "UX Movement: Why you should never use pure black for text",
      },
    ],
  },
];
