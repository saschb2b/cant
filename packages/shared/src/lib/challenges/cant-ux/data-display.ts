...
export const dataDisplayChallenges: BaseChallenge[] = [
  {
    ...
    sources: [
      {
        url: "https://www.nngroup.com/articles/table-design-patterns/",
        label: "NN/G: Table design patterns",
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: "https://www.nngroup.com/articles/truncation-in-data-tables/",
        label: "NN/G: Truncation in data tables",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "Dark Horse Analytics: Data looks better naked",
      },
    ],
  },
  {
