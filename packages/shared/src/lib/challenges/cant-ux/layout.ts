    ...
    sources: [
      {
        ...
        label: "Practical Typography: Line length",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "Nielsen Norman Group: Web form design guidelines",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "Nielsen Norman Group: Cards component in UX",
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: "https://practicaltypography.com/centered-text.html",
        label: "Practical Typography: Centered text",
      },
    ],
  },
];
