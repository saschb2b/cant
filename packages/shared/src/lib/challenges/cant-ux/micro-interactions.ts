...
export const microInteractionsChallenges: BaseChallenge[] = [
  {
    ...
    sources: [
      {
        url: "https://www.nngroup.com/articles/buttons-vs-links/",
        label: "NN/G: Button states and feedback",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "Material Design: Switch component",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "Material Design: Motion principles",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "NN/G: Progress indicators",
      },
    ],
  },
];
