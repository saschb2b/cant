...
export default async function sitemap():
  ...
  return [
    ...
    sources: [
      {
        url: "https://nextjs.org/docs/app/api-reference/file-conventions/metadata/sitemap#generating-a-sitemap-using-code",
        label: "Next.js: Dynamic sitemap generation",
      },
    ],
  },
  {
...
export default async function sitemap({
  ...
  return products.map((p) => ({
    ...
    sources: [
      {
        url: "https://nextjs.org/docs/app/api-reference/file-conventions/metadata/sitemap#generating-multiple-sitemaps",
        label: "Next.js: Multiple sitemaps",
      },
    ],
  },
  {
...
export default async function sitemap():
  ...
  return posts.map((post) => ({
    ...
    sources: [
      {
        url: "https://developers.google.com/search/docs/crawling-indexing/sitemaps/build-sitemap#additional-notes-about-xml-sitemaps",
        label: "Google: Sitemap best practices",
      },
    ],
  },
  {
...
export default function sitemap():
  ...
  return [
    ...
    sources: [
      {
        url: "https://www.sitemaps.org/protocol.html#prioritydef",
        label: "Sitemaps.org: Priority definition",
      },
    ],
  },
];
