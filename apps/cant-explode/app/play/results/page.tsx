...
export async function generateMetadata({
  ...
  if (!decoded) {
    return { title: "Results | Can't Explode" };
  }
  ...
  const title = `${rank} - ${String(score)}/${String(total)} | Can't Explode`;
  const description = `I scored ${String(score)}/${String(total)} on chemistry molecule comparisons. Can you beat my score? Test your chemistry instincts in under 5 minutes.`;
  const ogImage = "https://cant-explode.saschb2b.com/opengraph-image";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Can't Explode: Chemistry Challenge Game",
        },
      ],
    },
    twitter: {
