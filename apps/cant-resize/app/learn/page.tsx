...
export default async function LearnPage() {
  ...
  return (
    <LearnIndexPage
      ...
      subtitle="Learn responsive design patterns across 16 categories. Side-by-side fragile vs resilient code examples with explanations."
      ...
      learningPathDescription="New to responsive design? Follow these five categories in order."
    />
  );
}
