...
export function generateMetadata({ searchParams }: Props): Promise<Metadata> {
  return buildResultsMetadata(searchParams, {
    ...
    siteUrl: "https://cant-resize.saschb2b.com",
    ogAlt: "Can't Resize: Responsive Design Game",
    describeScore: (score, total) =>
      `I scored ${String(score)}/${String(total)} on spotting better responsive patterns. Can you beat my score? Train your eye for clean responsive design in under 5 minutes.`,
    decodeResults,
    getRank,
  });
}
