...
export const metadata: Metadata = {
  title: "Learn",
  description:
    "Learn SEO patterns for Next.js across 8 categories. Side-by-side suboptimal vs recommended code examples with explanations.",
};
...
export default async function LearnPage() {
  ...
  return (
    <LearnIndexPage
      title="Learn SEO for Next.js"
      subtitle="Learn SEO patterns for Next.js across 8 categories. Side-by-side suboptimal vs recommended code examples with explanations."
