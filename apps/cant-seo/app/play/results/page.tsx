...
export async function generateMetadata({
  ...
  if (!decoded) {
    return { title: "Results | Can't SEO" };
  }
  ...
  const title = `${rank} — ${String(score)}/${String(total)} | Can't SEO`;
  const description = `I scored ${String(score)}/${String(total)} on spotting better SEO patterns. Can you beat my score? Train your eye for clean metadata in under 5 minutes.`;
  const ogImage = "https://cant-seo.saschb2b.com/opengraph-image";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Can't SEO: SEO Patterns Game",
        },
      ],
    },
    twitter: {
