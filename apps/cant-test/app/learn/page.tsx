...
export const metadata: Metadata = {
  title: "Learn",
  description:
    "Learn testing patterns across 7 categories. Side-by-side fragile vs resilient code examples with explanations.",
};
...
export default async function LearnPage() {
  ...
  return (
    <LearnIndexPage
      ...
      subtitle="Learn testing patterns across 7 categories. Side-by-side fragile vs resilient code examples with explanations."
      ...
      learningPathDescription="New to testing? Follow these five categories in order."
    />
  );
}
