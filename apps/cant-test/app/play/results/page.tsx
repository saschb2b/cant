...
export async function generateMetadata({
  ...
  if (!decoded) {
    return { title: "Results | Can't Test" };
  }
  ...
  const title = `${rank} — ${String(score)}/${String(total)} | Can't Test`;
  const description = `I scored ${String(score)}/${String(total)} on spotting better testing patterns. Can you beat my score? Train your eye for clean testing in under 5 minutes.`;
  const ogImage = "https://cant-test.saschb2b.com/opengraph-image";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Can't Test: Testing Patterns Game",
        },
      ],
    },
    twitter: {
