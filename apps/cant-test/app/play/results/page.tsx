...
export function generateMetadata({ searchParams }: Props): Promise<Metadata> {
  return buildResultsMetadata(searchParams, {
    appName: "Can't Test",
    siteUrl: "https://cant-test.saschb2b.com",
    ogAlt: "Can't Test: Testing Patterns Game",
    describeScore: (score, total) =>
      `I scored ${String(score)}/${String(total)} on spotting better testing patterns. Can you beat my score? Train your eye for clean testing in under 5 minutes.`,
    decodeResults,
    getRank,
  });
}
