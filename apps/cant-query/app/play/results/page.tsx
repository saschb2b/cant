...
export function generateMetadata({ searchParams }: Props): Promise<Metadata> {
  return buildResultsMetadata(searchParams, {
    appName: "Can't Query",
    siteUrl: "https://cant-query.saschb2b.com",
    ogAlt: "Can't Query: API Endpoint Patterns Game",
    describeScore: (score, total) =>
      `I scored ${String(score)}/${String(total)} on spotting better API patterns. Can you beat my score? Train your eye for clean API design in under 5 minutes.`,
    decodeResults,
    getRank,
  });
}
