...
export async function generateMetadata({
  ...
  if (!decoded) {
    return { title: "Results | Can't Query" };
  }
  ...
  const title = `${rank} — ${String(score)}/${String(total)} | Can't Query`;
  const description = `I scored ${String(score)}/${String(total)} on spotting better API patterns. Can you beat my score? Train your eye for clean API design in under 5 minutes.`;
  const ogImage = "https://cant-query.saschb2b.com/opengraph-image";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Can't Query: API Endpoint Patterns Game",
        },
      ],
    },
    twitter: {
