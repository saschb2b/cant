...
export default function LearnPage() {
  ...
  return (
    <LearnIndexPage
      ...
      subtitle="Learn UX design patterns across 7 categories. Side-by-side visual comparisons with explanations."
      ...
      learningPathDescription="New to UX design? Follow these five categories in order."
    />
  );
}
