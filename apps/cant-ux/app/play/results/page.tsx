...
export async function generateMetadata({
  ...
  const title = `${rank} — ${String(score)}/${String(total)} | Can't UX`;
  ...
  const ogImage = "https://cant-ux.saschb2b.com/opengraph-image";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Can't UX: UX Design Patterns Game",
        },
      ],
    },
    twitter: {
