...
export function generateMetadata({ searchParams }: Props): Promise<Metadata> {
  return buildResultsMetadata(searchParams, {
    appName: "Can't UX",
    siteUrl: "https://cant-ux.saschb2b.com",
    ogAlt: "Can't UX: UX Design Patterns Game",
    describeScore: (score, total) =>
      `I scored ${String(score)}/${String(total)} on spotting better UX patterns. Can you beat my score? Train your design eye in under 5 minutes.`,
    decodeResults,
    getRank,
  });
}
