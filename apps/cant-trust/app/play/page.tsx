...
import { challenges as _challenges } from "@cant/shared/lib/challenges/cant-trust";
...
export const metadata: Metadata = {
  title: "Play",
  description:
    "Pick the better approach in 10 side-by-side challenges covering money, banking, inflation, cryptography, and Bitcoin.",
};
