...
export async function generateMetadata({
  ...
  if (!decoded) {
    return { title: "Results | Can't Game" };
  }
  ...
  const title = `${rank} — ${String(score)}/${String(total)} | Can't Game`;
  const description = `I scored ${String(score)}/${String(total)} on spotting better game dev patterns. Can you beat my score? Train your eye for clean game architecture in under 5 minutes.`;
  const ogImage = "https://cant-game.saschb2b.com/opengraph-image";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Can't Game: Game Dev Patterns",
        },
      ],
    },
    twitter: {
