...
import { challenges as _challenges } from "@cant/shared/lib/challenges/cant-game";
...
export const metadata: Metadata = {
  title: "Play",
  description:
    "Pick the better game dev pattern in 10 side-by-side code challenges. Covers game loops, physics, rendering, AI, and more.",
};
