...
export const metadata: Metadata = {
  title: "Learn",
  description:
    "Learn TypeScript patterns across 16 categories. Side-by-side fragile vs resilient code examples with explanations.",
};
...
export default async function LearnPage() {
  ...
  return (
    <LearnIndexPage
      ...
      subtitle="Learn TypeScript patterns across 16 categories. Side-by-side fragile vs resilient code examples with explanations."
