...
export async function generateMetadata({
  ...
  if (!decoded) {
    return { title: "Results | Can't Branch" };
  }
  ...
  const title = `${rank} — ${String(score)}/${String(total)} | Can't Branch`;
  const description = `I scored ${String(score)}/${String(total)} on spotting better git workflows. Can you beat my score? Train your eye for clean git practices in under 5 minutes.`;
  const ogImage = "https://cant-branch.saschb2b.com/opengraph-image";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Can't Branch — Git Best Practices Game",
        },
      ],
    },
    twitter: {
