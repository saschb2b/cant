...
import { challenges as _challenges } from "@cant/shared/lib/challenges/cant-orchestrate";
...
export const metadata: Metadata = {
  title: "Play",
  description:
    "Pick the better container orchestration pattern in 10 side-by-side code challenges. Covers Docker, Kubernetes, Helm, and more.",
};
