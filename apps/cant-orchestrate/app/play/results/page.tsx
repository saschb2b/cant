...
export async function generateMetadata({
  ...
  if (!decoded) {
    return { title: "Results | Can't Orchestrate" };
  }
  ...
  const title = `${rank} - ${String(score)}/${String(total)} | Can't Orchestrate`;
  const description = `I scored ${String(score)}/${String(total)} on spotting better container orchestration patterns. Can you beat my score? Train your eye for clean configs in under 5 minutes.`;
  const ogImage = "https://cant-orchestrate.saschb2b.com/opengraph-image";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Can't Orchestrate: Container Orchestration Pattern Game",
        },
      ],
    },
    twitter: {
