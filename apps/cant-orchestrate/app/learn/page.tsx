...
export const metadata: Metadata = {
  title: "Learn",
  description:
    "Learn container orchestration patterns across 16 categories. Side-by-side fragile vs resilient code examples with explanations.",
};
...
export default async function LearnPage() {
  ...
  return (
    <LearnIndexPage
      title="Learn Orchestration Patterns"
      subtitle="Learn container orchestration patterns across 16 categories. Side-by-side fragile vs resilient code examples with explanations."
      ...
      learningPathDescription="New to container orchestration? Follow these five categories in order."
    />
  );
}
